module Screen
  class ComplexCheckInScreen < PM::Screen
    stylesheet :complex_check_in_styles
    ...
    def will_appear
      ...
      @scroll_view = subview UIScrollView, :scroll_view do 
        ...
        # @comments_view = subview(UITextView.alloc.initWithFrame(CGRectMake(20, 80, 250, 100)), :comments_view)
